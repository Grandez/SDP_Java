...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Fri Nov 24 22:54:16 CET 2017
  */
...
class CUP$CalcParser$actions {
   ...
   private CalcItem loadValue(String name, Symbol s) {
      ...
      if (toks.length > 1) {
         ...
         do {
           obj = Reflect.executeMethod(obj, "get" + toks[idx++]);
         } while (idx + 1 < toks.length);
      }
      
      Object res = Reflect.executeMethod(obj, "get" + toks[idx]);
