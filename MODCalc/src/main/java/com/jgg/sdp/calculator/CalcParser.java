...
import java.util.*;
import com.jgg.parsers.runtime.*;
import com.jgg.sdp.tools.SDPJava;

/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Oct 16 13:19:06 CEST 2017
  */
...
class CUP$CalcParser$actions {
   ...
   private CalcItem loadValue(String name, Symbol s) {
      ...
      if (toks.length > 1) {
         ...
         do {
           obj = SDPJava.executeMethod(obj, "get" + toks[idx++]);
         } while (idx + 1 < toks.length);
      }
      
      Object res = SDPJava.executeMethod(obj, "get" + toks[idx]);
