...
public class CFG {
    ...
    public static final String PARSER_MODE    = "parser.mode";
    public static final int    PARSER_LOCAL   = 1;
    public static final int    PARSER_CMD     = 2;
    public static final int    PARSER_MASSIVE = 3;
