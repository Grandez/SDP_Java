...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Feb 07 09:52:54 CET 2018
  */
  ...
  public final java_cup.runtime.Symbol CUP$COPYParser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$COPYParser$act_num)
		...
		SDPSymbol s = (SDPSymbol)((java_cup.runtime.Symbol) CUP$COPYParser$stack.peek()).value;
		 RESULT = s; 
		...
		SDPSymbol s = (SDPSymbol)((java_cup.runtime.Symbol) CUP$COPYParser$stack.elementAt(CUP$COPYParser$top-1)).value;
		...
		SDPSymbol c = (SDPSymbol)((java_cup.runtime.Symbol) CUP$COPYParser$stack.peek()).value;
		 RESULT = s.add(c);  
		...
		SDPSymbol l = (SDPSymbol)((java_cup.runtime.Symbol) CUP$COPYParser$stack.peek()).value;
		...
		SDPSymbol c = (SDPSymbol)((java_cup.runtime.Symbol) CUP$COPYParser$stack.elementAt(CUP$COPYParser$top-1)).value;
		...
		SDPSymbol p = (SDPSymbol)((java_cup.runtime.Symbol) CUP$COPYParser$stack.peek()).value;
		...
		SDPSymbol m = (SDPSymbol)((java_cup.runtime.Symbol) CUP$COPYParser$stack.elementAt(CUP$COPYParser$top-1)).value;
		...
		StmtCopy start_val = (StmtCopy)((java_cup.runtime.Symbol) CUP$COPYParser$stack.elementAt(CUP$COPYParser$top-1)).value;
		RESULT = start_val;
		...
		int sleft = ((java_cup.runtime.Symbol)CUP$COPYParser$stack.peek()).left;
		int sright = ((java_cup.runtime.Symbol)CUP$COPYParser$stack.peek()).right;
		StmtCopy s = (StmtCopy)((java_cup.runtime.Symbol) CUP$COPYParser$stack.peek()).value;
