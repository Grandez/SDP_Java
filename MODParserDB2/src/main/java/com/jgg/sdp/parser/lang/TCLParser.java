...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Feb 10 21:20:00 CET 2018
  */
public class TCLParser extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    ...
    "\002\000\004\002\022\001\002\000\002\001\ufffb\000\002" +
    "\001\ufffd\000\002\001\000\000\002\001\uffed\000\004\015" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\124\000\022\002\016\003\004\004\013\005\012\006" +
    "\020\007\010\010\017\011\014\001\001\000\002\001\001" +
...
class CUP$TCLParser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$TCLParser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$TCLParser$act_num)
          ...
          case 37: // sql_refresh ::= REFRESH TABLE NT$5 table_name opt_clause_queryno 
            {
              ...
              // propagate RESULT from NT$5
                RESULT = (StmtSQL) ((java_cup.runtime.Symbol) CUP$TCLParser$stack.elementAt(CUP$TCLParser$top-2)).value;
		...
		SDPSymbol r = (SDPSymbol)((java_cup.runtime.Symbol) CUP$TCLParser$stack.elementAt(CUP$TCLParser$top-4)).value;
		...
		SDPSymbol t = (SDPSymbol)((java_cup.runtime.Symbol) CUP$TCLParser$stack.elementAt(CUP$TCLParser$top-3)).value;
		...
		SDPSymbol r = (SDPSymbol)((java_cup.runtime.Symbol) CUP$TCLParser$stack.elementAt(CUP$TCLParser$top-1)).value;
		...
		SDPSymbol t = (SDPSymbol)((java_cup.runtime.Symbol) CUP$TCLParser$stack.peek()).value;
 stmt.setVerb(r,t); 
          ...
          case 29: // sql_release ::= RELEASE NT$4 sql_release_type 
            {
              ...
              // propagate RESULT from NT$4
                RESULT = (StmtSQL) ((java_cup.runtime.Symbol) CUP$TCLParser$stack.elementAt(CUP$TCLParser$top-1)).value;
		...
		SDPSymbol v = (SDPSymbol)((java_cup.runtime.Symbol) CUP$TCLParser$stack.elementAt(CUP$TCLParser$top-2)).value;
		...
		SDPSymbol v = (SDPSymbol)((java_cup.runtime.Symbol) CUP$TCLParser$stack.peek()).value;
 stmt.setVerb(v); 
          ...
          case 21: // sql_lock_table ::= LOCK TABLE NT$3 table_name lock_partition_opt IN lock_mode_opt MODE 
            {
              ...
              // propagate RESULT from NT$3
                RESULT = (StmtSQL) ((java_cup.runtime.Symbol) CUP$TCLParser$stack.elementAt(CUP$TCLParser$top-5)).value;
		...
		SDPSymbol l = (SDPSymbol)((java_cup.runtime.Symbol) CUP$TCLParser$stack.elementAt(CUP$TCLParser$top-7)).value;
		...
		SDPSymbol t = (SDPSymbol)((java_cup.runtime.Symbol) CUP$TCLParser$stack.elementAt(CUP$TCLParser$top-6)).value;
		...
		SDPSymbol l = (SDPSymbol)((java_cup.runtime.Symbol) CUP$TCLParser$stack.elementAt(CUP$TCLParser$top-1)).value;
		int tleft = ((java_cup.runtime.Symbol)CUP$TCLParser$stack.peek()).left;
		int tright = ((java_cup.runtime.Symbol)CUP$TCLParser$stack.peek()).right;
		SDPSymbol t = (SDPSymbol)((java_cup.runtime.Symbol) CUP$TCLParser$stack.peek()).value;
 stmt.setVerb(l, t); 
          ...
          case 13: // sql_savepoint ::= SAVEPOINT NT$2 id opt_unique sql_savepoint_opt 
            {
              ...
              // propagate RESULT from NT$2
                RESULT = (StmtSQL) ((java_cup.runtime.Symbol) CUP$TCLParser$stack.elementAt(CUP$TCLParser$top-3)).value;
		...
		SDPSymbol v = (SDPSymbol)((java_cup.runtime.Symbol) CUP$TCLParser$stack.elementAt(CUP$TCLParser$top-4)).value;
 ...
 stmt.setVerb(v); 
		...
		SDPSymbol v = (SDPSymbol)((java_cup.runtime.Symbol) CUP$TCLParser$stack.elementAt(CUP$TCLParser$top-3)).value;
 ...
 stmt.setVerb(v); 
		...
		RESULT = start_val;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 0: // sql_stmt ::= sql_tcl 
            {
              Symbol RESULT =null;
		int sleft = ((java_cup.runtime.Symbol)CUP$TCLParser$stack.peek()).left;
		int sright = ((java_cup.runtime.Symbol)CUP$TCLParser$stack.peek()).right;
		StmtSQL s = (StmtSQL)((java_cup.runtime.Symbol) CUP$TCLParser$stack.peek()).value;
		 stmt.adjust(info.getLastSymbol()); 
                          RESULT = symbolFactory.newSymbol(0, 0, 0, stmt); 
                       
              CUP$TCLParser$result = parser.getSymbolFactory().newSymbol("sql_stmt",0, ((java_cup.runtime.Symbol)CUP$TCLParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$TCLParser$stack.peek()), RESULT);
            }
          return CUP$TCLParser$result;
