 ...
 */
package com.jgg.sdp.tools.json;
...
public class JSONValue {
	 ...
	 * 
	 * @see com.jgg.sdp.tools.json.JSONParser#parse(Reader)
	 ...
	 * Parse JSON text into java object from the input source.
	 * 
	 * @see com.jgg.sdp.tools.json.JSONParser
	 * 
	 * @param in
	 * @return Instance of the following:
	 * 	org.json.simple.JSONObject,
     ...
     * 
     * @see com.jgg.sdp.tools.json.JSONObject#writeJSONString(Map, Writer)
     * @see com.jgg.sdp.tools.json.JSONArray#writeJSONString(List, Writer)
     * 
     * @param value
     * @param writer
     */
	 ...
	 * 
	 * @see com.jgg.sdp.tools.json.JSONObject#toJSONString(Map)
	 * @see com.jgg.sdp.tools.json.JSONArray#toJSONString(List)
	 * 
	 * @param value
