...
public class Propiedades {
    ...
    /**
     * Carga un fichero de propiedades como recurso .
     *
     * @param resourceName
     *            the resource name
     * @return Hash con el conjunto de claves/valor
     */
    ...
    /**
     * Carga un fichero de propiedades desde un fichero externo .
     *
     * @param resourceName
     *            the resource name
     * @return Hash con el conjunto de claves/valor
     */    
    public HashMap<String, String> loadConfiguration(String resourceName) {
    ...
    private BufferedReader getFile(String resourceName) {
        ...
        try {
            in = new BufferedReader(new FileReader(new File(resName)));
