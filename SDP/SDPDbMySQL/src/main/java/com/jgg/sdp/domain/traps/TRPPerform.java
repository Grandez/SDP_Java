...
@Entity
@Table(name="TRP_PERFORM")
public class TRPPerform implements Serializable {

   private static final long serialVersionUID = -2672462434686729914L;
...
public boolean equals(Object obj) {
	...
	if (getClass() != obj.getClass())
		return false;
	TRPPerform other = (TRPPerform) obj;
	if (etiqueta == null) {
