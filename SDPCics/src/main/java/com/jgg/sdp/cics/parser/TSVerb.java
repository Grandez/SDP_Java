...
public class TSVerb {
	...
	private HashSet<String>         qr    = new HashSet<String>();
	...
	public void addQR(String option) {
		qr.add(option);
	}
	...
	public ArrayList<String> getOptionsQRBloqueante() {
		return new ArrayList<String>(qr);
	}
