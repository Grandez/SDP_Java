...
public class FactoryLexer implements java_cup.runtime.Scanner {
	
	private Configuration cfg = Configuration.getInstance();
	
	private CopyLoader  loader    = new CopyLoader();	

	private static Scanner scanner;  // Scanner para los Parser
...
//		        	  sym = createCopy(s);
   ...
   private Symbol parseAlter(int type) throws Exception {
	   ...
	   Scanner scanner = getLexer(source, type);

   	   GenericParser parser = FactoryParser.getParser(scanner, source, type);
