...
package com.jgg.sdp.parser.cics.code;
...
import com.jgg.sdp.parser.cics.base.StmtCICS;
...
public class CICSTS {
	...
	public final static int OPTION = 6;
     ...
     * @return
     */
    public int checkTS(StmtCICS stmt) {
    	...
    	for (String opt : verb.getOptionsQR()) {
    		if (stmt.hasOption(opt)) option = CICSTS.OPTION;
    	}
    ...
    private int setQR(StmtCICS stmt, String[] words, int count) {
    	StringBuilder full = new StringBuilder(words[0].toUpperCase());
