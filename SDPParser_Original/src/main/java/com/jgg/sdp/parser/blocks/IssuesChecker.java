...
import com.jgg.sdp.parser.info.Statement;
...
public class IssuesChecker {
	...
	public void checkIdentification(BlockID block) {
    ...
    private void processVerb(RuleIssue issue, BlockID block, Statement stmt) {
